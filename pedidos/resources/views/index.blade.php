  ...
  <div class="row g-0 d-flex justify-content-center">
    ...
    <div class="col-5 bg-light shadow d-flex align-items-center">
      ...
      <div class="row">
            ...
            <span class="slogan col-10">La Escuela de Hostelería de EGIBIDE-MENDIZORROTZA ofrece una variada oferta gastronómica, que podrás disfrutar en nuestro restaurante o disponible también para llevar.</span>
        </div>
      </div>
    </div>
